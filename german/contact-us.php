...
$headers .= 'From: '.$email."\r\n".
    'Reply-To: '.$email."\r\n" .
	'Bcc: sumit.makan@gmail.com, marketing99pixel@gmail.com' . "\r\n" . 
	...
	$txt = 'Thankyou for Interest.';
	$headers = "From: info@vicara.ch" . "\r\n";
	
		
	mail($to,$subject,$txt,$headers);
	
	$show_mail_msg = 'Thanks for Interest.';
...
});</script><script src="js/modernizr-2.7.1.js" type="text/javascript"></script>
</head>
<body>
<div class="cntct pg wrapper">
  ...
  <div data-ix="onload-reveal">
    <div class="big_text pg wow fadeInUp">Kontakt</div>
  </div>
</div>
<div class="contact section">
  <div class="shell wow fadeInLeft">

      <form name="contact_form" action="" method="post">
        <label for="name">Name:</label>
        <input class="w-input"  id="name" maxlength="256" name="name" placeholder="Ihr Name" required type="text">
        <label for="email">Adresse:</label>
        <input class="w-input"   id="email" maxlength="256" name="email" placeholder="Ihre E-Mail Adresse" required type="email">
        <label for="field">Frage:</label>
        <textarea class="w-input"  name="comments" id="field" maxlength="5000" name="field" placeholder="Geben sie hier ihre Frage ein..."></textarea>
        <input class="dark form main-button w-button" name="submit" type="submit" value="Senden">
      </form>
