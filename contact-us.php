...
$headers .= 'From: '.$email."\r\n".
    'Reply-To: '.$email."\r\n" .
	'Bcc: sumit.makan@gmail.com, samreshitanexpert@gmail.com' . "\r\n" . 
...
<div class="cntct pg wrapper">
  ...
  <div data-ix="onload-reveal">
    <div class="big_text pg wow fadeInUp">Contact Us</div>
  </div>
</div>
<div class="contact section">
  <div class="shell wow fadeInLeft">
      ...
      <form name="contact_form" action="" method="post">
        ...
        <input class="w-input" name="name" id="name" maxlength="256"  placeholder="Enter your name" required type="text">
        <label for="email">Email Address:</label>
        <input class="w-input" name="email" id="email" maxlength="256"  placeholder="Enter your email address" required type="email">
        <label for="field">Query:</label>
        <textarea class="w-input" name="comments" id="field" maxlength="5000"  placeholder="Enter Query here"></textarea>
        <input class="dark form main-button w-button" name="submit"  type="submit" value="Submit">
      </form>
